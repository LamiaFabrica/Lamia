...
private:
    ...
    void test_manufacturing_bridges() {
        ...
        // Test CNC bridge
        std::string cnc_test = "cd manufacturing_bridges && g++ -std=gnu++26 -shared -fPIC -o libcnc_bridge.so manufacturing_cnc_bridge.cpp 2>&1";
        ...
        // Test Arduino bridge
        std::string arduino_test = "cd manufacturing_bridges && g++ -std=gnu++26 -shared -fPIC -o libarduino_bridge.so arduino_transpiler.cpp 2>&1";
        ...
        // Test IoT bridge
        std::string iot_test = "cd manufacturing_bridges && g++ -std=gnu++26 -shared -fPIC -o libiot_bridge.so iot_framework.cpp 2>&1";
